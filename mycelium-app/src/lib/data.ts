...
export const ORGS: Org[] = [
  ...
  { id: 'proveg-intl', name: 'Planetary Plates Network', country: 'Global', logo: 'PP', tint: '#3D5A80', streams: ['public-food', 'culinary'], members: 3 },
  { id: 'vegansoc', name: 'The Vegan Society', country: 'UK', logo: 'VS', tint: '#74C69D', streams: ['consumer', 'capacity'], members: 4 },
  { id: 'eapf', name: 'European Alliance for Plant-based Foods', country: 'EU', logo: 'EA', tint: '#3A5A40', streams: ['policy', 'corporate'], members: 4 },
...
export const PEOPLE: Person[] = [
  ...
  { id: 'u-finn', name: "Finn O'Brien", org: 'eapf', role: 'Policy Strategist', country: 'Ireland', streams: ['policy', 'consumer'], title: 'Member', tint: '#52796F' },
  { id: 'u-elena', name: 'Elena Marchetti', org: 'eapf', role: 'Senior Policy Officer', country: 'Italy/EU', streams: ['policy', 'law'], title: 'Track Lead — Policy & Advocacy', tint: '#3D5A80' },
...
export const CAMPAIGNS: Campaign[] = [
  ...
  { id: 'c-protein', title: 'Plant Protein Strategy — EU Green Deal alignment', org: 'eapf', streams: ['policy', 'corporate'], start: '2026-06-10', end: '2026-09-30', featured: true, cta: 'Submit position papers on the EU protein strategy consultation. Aligned messaging toolkit available in the Hub.', support: ['policy_action'], description: 'The EU protein strategy review is our chance to shift subsidies toward plant protein. Coordinated response across all member states.', supporters: 58 },
...
export const UPCOMING_TASKS: UpcomingTask[] = [
  ...
  { label: 'Review EU protein strategy position paper', due: 'Due Jun 09', stream: 'policy' },
];
