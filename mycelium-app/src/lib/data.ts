...
export const CAMPAIGNS: Campaign[] = [
  ...
  { id: 'c-altprot', title: 'Alt-Protein Regulation Briefing — DG SANTE', org: 'gfi-eu', streams: ['altprot', 'policy'], start: '2026-06-18', end: '2026-06-18', featured: false, cta: 'Closed-door briefing. RSVP-only. If your org has European cultivated meat producers in its network, please flag for invite list.', support: ['event'], description: 'Setting the technical agenda for the next Novel Food regulation review.', supporters: 8 },
];

export const LEARNINGS: Learning[] = [
  { id: 'l-school', author: 'u-jonas', title: 'What worked (and didn\u2019t) in our Copenhagen schools pilot', streams: ['health', 'policy'], content: 'Three things mattered more than we expected: (1) the chefs, not the parents, were the hardest sell — their identity was tied to the old menu; (2) reframing as \u201cdefault plant + opt-in meat\u201d worked, \u201cmeatless Mondays\u201d didn\u2019t; (3) the dietitian endorsement letter unlocked the principals. Happy to share the template.', when: '2 days ago', reactions: { helpful: 24, insightful: 12, bookmarked: 9 }, comments: 7, pinned: true },
...
export const SOCIAL_POSTS: SocialPost[] = [
  ...
  { id: 'sp-3', user: 'u-priya', org: 'gfi-eu', platform: 'linkedin', streams: ['altprot', 'research'], description: 'New consumer-language report on cultivated meat. Methodology + raw data linked.', request: 'Comment with which finding surprised you most', when: '1d ago', engagements: 18 },
  { id: 'sp-4', user: 'u-jonas', org: 'dvf', platform: 'instagram', streams: ['health'], description: 'Behind-the-scenes from the Copenhagen schools pilot. Visuals are strong this time.', request: 'Repost to stories', when: '1d ago', engagements: 31 },
  ...
  { id: 'sp-6', user: 'u-isabel', org: 'animaleq', platform: 'twitter', streams: ['policy', 'consumer'], description: 'Spanish supermarket undercover — footage drops Friday. Building pre-release momentum.', request: 'Like + bookmark the teaser thread', when: '2d ago', engagements: 15 },
];
