    ...
    <div className="myc-onb-shell">
      ...
      <div className="myc-onb-left">
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 60 }}>
          ...
          <div>
            <div style={{ fontFamily: 'DM Sans', fontWeight: 700, fontSize: 17, color: 'var(--myc-primary)' }}>Mycelium</div>
      ...
      <div className="myc-onb-right">
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          <blockquote style={{ margin: 0, fontFamily: 'DM Sans', fontSize: 22, fontWeight: 500, letterSpacing: -0.3, lineHeight: 1.35, color: '#fff', textWrap: 'balance' }}>
            "A forest with a healthy mycelial network is dramatically more resilient than one without. No single tree is the forest."
          </blockquote>
